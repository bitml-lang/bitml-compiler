...
(define (txFee) "txid:somethingelse@0")
...
(define (Future t t+d Contract)
  (choice
   ...
   (after t+d (split (1 -> (withdraw "A")) (1 -> (withdraw "I"))))))
...
(contract
 (pre (deposit "A" 1 (ref (txA))) (deposit "A" 1 (ref (txFee))))
 
 (ref (EuropeanOption "A" 1500000 1550000 (withdraw "A") (withdraw "I")))
